...
from data.dataset import get_min_max, denorm_np
...
class VisualWriter():
    ...
    def __init__(self, opt, logger):
        ...
        self.enabled = opt['train']['tensorboard']
        self.rank = opt['global_rank']

        phase = opt['phase']
        self.dataset_name = opt['datasets'][phase]['which_dataset']['args']['type']
        self.denorm_fn = denorm_np()
