...
class UNet(torch.nn.Module):
    def __init__(self,
        ...
        **block_kwargs,                     # Arguments for Block.
        ...
        self.out_conv = MPConv(cout, out_channel, kernel=[3,3])

    def forward(self, x, noise_labels):
        # Embedding.
        emb = self.emb_noise(self.emb_fourier(noise_labels.squeeze(dim=-1)))
        emb = mp_silu(emb)
